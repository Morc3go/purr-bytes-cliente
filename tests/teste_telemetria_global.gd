...
func teste_tentativa_de_fase_alta_nao_e_descartada() -> void:
	Sessao.iniciar()
	Sessao.entrar_na_fase(97, 3, "11111111-2222-3333-4444-555555555555", "fase criada pelo professor")
	...
	afirmar_igual(String(tentativa["id_fase"]), "11111111-2222-3333-4444-555555555555",
...
func teste_evento_de_fase_alta_carrega_id_fase() -> void:
	Sessao.iniciar()
	Sessao.entrar_na_fase(42, 3, "aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee", "outra fase")
	...
	afirmar_igual(String(evento["id_fase"]), "aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee",
...
func teste_fase_de_1_a_4_continua_enviando_o_numero_legado() -> void:
	Sessao.iniciar()
	Sessao.entrar_na_fase(2, 3, "cccccccc-dddd-eeee-ffff-000000000000", "fase 2")
...
func teste_sessao_nao_limita_mais_a_fase_a_quatro() -> void:
	Sessao.iniciar()
	Sessao.entrar_na_fase(12, 3, "dddddddd-1111-2222-3333-444444444444", "decima segunda")

	afirmar_igual(Sessao.fase_atual, 12, "o numero da fase nao e mais grampeado em 4")
	afirmar_igual(Sessao.id_fase, "dddddddd-1111-2222-3333-444444444444", "a sessao guarda a identidade")
